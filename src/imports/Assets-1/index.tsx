import svgPaths from "./svg-z9fn906kpu";
...
function Container15() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Google_Sans_Flex:Medium','Noto_Sans_Symbols2:Regular',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#7fbfa8] text-[0px] w-full" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>
        <p className="text-[14px]">
          <span className="leading-[normal]">▼ 6.2%</span>
          <span className="[word-break:break-word] font-['Google_Sans_Flex:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-normal leading-[normal] not-italic text-[#aaa]" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>{` vs same period last year`}</span>
        </p>
      </div>
    </div>
  );
...
function Container17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Google_Sans_Flex:Medium','Noto_Sans_Symbols2:Regular',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#467855] text-[0px] w-full" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>
        <p className="text-[14px]">
          <span className="leading-[normal]">▼ 4.8%</span>
          <span className="[word-break:break-word] font-['Google_Sans_Flex:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-normal leading-[normal] not-italic text-[#808080]" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>{` vs baseline`}</span>
        </p>
      </div>
    </div>
  );
...
function Link() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
      <div className="[word-break:break-word] flex flex-col font-['Google_Sans_Flex:Bold','Noto_Sans_Symbols:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#456c88] text-[14px] uppercase whitespace-nowrap" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>
